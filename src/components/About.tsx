            ...
            <div className="md:col-span-8 flex flex-col gap-24">
               <div className="flex flex-col gap-8">
                  <p className="text-3xl md:text-5xl font-light tracking-tight text-white/90 leading-[1.1]">
                     Saya <span className="text-accent underline decoration-[1px] underline-offset-8 italic font-serif">percaya</span> desain dan teknologi dapat membantu menyampaikan pesan, memecahkan masalah, dan menciptakan pengalaman yang <span className="text-accent underline decoration-[1px] underline-offset-8 italic font-serif">bermakna</span> bagi banyak orang.
                  </p>
                  <div className="flex gap-4 items-center">
                     <div className="h-[1px] w-12 bg-accent/50" />
                     <p className="text-sm font-mono text-white/40 tracking-wider">Creating meaningful digital experiences</p>
                  </div>
               </div>
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                  ...
                  <div className="flex flex-col justify-between py-8">
                     <p className="text-lg text-white/60 font-light leading-relaxed">
                        Saya adalah seseorang yang senang belajar hal baru dan menikmati proses kreatif dari sebuah ide menjadi hasil yang nyata. Saya terbiasa memperhatikan detail, beradaptasi dengan lingkungan baru, dan terus mengembangkan kemampuan melalui berbagai pengalaman dan project.                     </p>
                     <div className="flex flex-wrap gap-4 mt-8">
                        {['Full Stack Developer', 'Web Developer', 'Graphic Designer',].map(skill => (
